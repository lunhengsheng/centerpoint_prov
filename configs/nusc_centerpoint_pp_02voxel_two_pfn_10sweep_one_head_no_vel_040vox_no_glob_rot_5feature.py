...
voxel_size = (0.40, 0.40, 8)
pc_range = (-70.4, -70.4, -5.0, 70.4, 70.4, 3.0)
...
test_cfg = dict(
    post_center_limit_range=[-80, -80, -10.0, 80, 80, 10],
    max_per_img=500,
    nms=dict(
...
voxel_generator = dict(
    range=[-70.4, -70.4, -5.0, 70.4, 70.4, 3.0],
...
load_from = None #"models/latest.pth"
resume_from = None #"models/nusc_one_head_no_vel_040vox/epoch_200.pth"
workflow = [('train', 1)]
