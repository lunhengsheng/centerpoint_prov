...
pc_range = (-70.4, -70.4, -8.0, 70.4, 70.4, -2.0)
...
model = dict(
    ...
    cfe=dict(
        type="PillarContext3D_fsa",
        num_bev_features=64,
        in_dim=64,
        grid_size=grid_size,
    ),
    decoder2d=dict(
        type="ConcatBEVDecoder",
        in_dim=64,
        num_filters=[64, 128, 256],
...
test_cfg = dict(
    post_center_limit_range=[-80, -80, -10.0, 80, 80, 0],
    max_per_img=500,
    nms=dict(
...
voxel_generator = dict(
    range=[-70.4, -70.4, -8.0, 70.4, 70.4, -2.0],
    voxel_size=[0.16, 0.16, 6],
...
load_from = None
resume_from = None # "models/nusc_one_head_no_vel/epoch_110.pth"
workflow = [('train', 1)]
