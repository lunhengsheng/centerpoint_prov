...
voxel_size = (0.60, 0.60, 6)
pc_range = (-76.8, -76.8, -8.0, 76.8, 76.8, -2.0)
...
voxel_generator = dict(
    range=[-76.8, -76.8, -8.0, 76.8, 76.8, -2.0],
    voxel_size=[0.6, 0.6, 6.0],
...
load_from = None
resume_from = None# "models/nusc_one_head_no_vel/epoch_600.pth"
workflow = [('train', 1)]
