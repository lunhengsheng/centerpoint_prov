...
tasks = [
    ...
    #dict(num_class=1, class_names=["Tram"]),
]
...
test_cfg = dict(
    post_center_limit_range=[0, -60, -5.0, 100, 60, 5],
    max_per_img=500,
    nms=dict(
...
load_from = None #'models/kitti_4_heads_4_classes/epoch_54.pth'
resume_from = None
